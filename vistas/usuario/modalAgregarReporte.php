                    ...
                    <div class="row">
                        <div class="col-sm-3">
                            ...
                            <select type="text" class="form-control" id="delito" name="delito" required>
                                <option value=""></option>
                                <option value="7">Robo a transeunte</option>
                                <option value="5">Robo a casa habitación</option>
                                <option value="6">Robo a comercio</option>
                                <option value="8">Robo en transporte publico</option>
                                <option value="4">Robo a camiones repartidores</option>
                                <option value="9">Violación</option>
                                <option value="1">Abuso sexual</option>
                                <option value="3">Faltas administrativas</option>
                                <option value="11">Violencia familiar</option>
                                <option value="12">Violencia de genero</option>
                                <option value="10">Violencia contra niños y adolecentes</option>
                                <option value="2">Desaparicion de personas</option>
                            </select>
                        </div>
                        <div class="col-sm-3">
